...
public class DEMO_miller_rabin2{
    
    static BigInteger c = new BigInteger("2");
    static BigInteger d = new BigInteger("0");
    static BigInteger e = new BigInteger("1");
    static BigInteger a = new BigInteger("121");

    public static void algorith(){

        BigInteger i,b,m,lunci,v,w,z,f,u;
        u = new BigInteger("0");//初始化u
		...
		while (!a.subtract(e).equals(z)&& !v.equals(e) && !a.subtract(e).equals(v) )
		{
			...
			//System.out.println("u:"+u);
				...
				//System.out.println("u:"+u);
			if ( !a.subtract(e).equals(u)&  z.mod(c).equals(d) )  /*u没有定义？在//循环里u=q2.mod(a)已经定义了啊*/
